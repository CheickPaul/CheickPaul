...
- **Investments: Financial Markets, Options and Derivatives** — Summer University — Copenhagen Business School [✅](./cbs-summer--financial-markets-options-derivatives/)
- **Bloomberg Market Concepts (BMC)** — Bloomberg [✅](./bloomberg-market-concepts/)
- **Financial Markets** — Yale University (Coursera) [✅](./Yale-financial-markets/)
- **Executive Programme in Algorithmic Trading (EPAT)** — QuantInsti [⏳](./epat--quantinsti/)
