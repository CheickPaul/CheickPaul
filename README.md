...
I hold a Bachelor’s degree in Physics and a MSc in Supply Chain and Purchasing.
...
*Tip: For the best experience and a full overview (structure, modules, notes, and progress), open the underlined repositories first, then use the **Quick Access** section. You can also click the ✅ / ⏳ icons for direct access to each course folder.*
...
- **Investments: Financial Markets, Options and Derivatives** — Summer University — Copenhagen Business School [✅](https://github.com/CheickPaul/Finance-Python-Learning-Portfolio/tree/main/cbs-summer--financial-markets-options-derivatives)
